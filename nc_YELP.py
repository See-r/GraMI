...
from utils.input_data import load_YELP_data
...
parser.add_argument('--loss-lambda1', type=float, default=0., help='Coefficient lambda to balance loss.')
parser.add_argument('--loss-lambda2', type=float, default=0.5, help='Coefficient lambda to balance loss.')
parser.add_argument('--dataset', type=str, default='YELP', help='type of dataset.')
...
parser.add_argument('--task', type=str, default='bs',
                    help='the choise of tasks,bu/bs/bl is prediction of links, fea is prediction of feature.')
...
parser.add_argument('--src-node', type=int, default=0,
...
def nc_YELP(args):
    ...
    print('--------args----------\n')
    features_list, adjM, type_mask, labels, train_val_test_idx = load_YELP_data()
