...
parser.add_argument('--hidden-dim', type=int, default=128, help='Number of units in fc_layer.')
...
parser.add_argument('--loss-lambda2', type=float, default=0., help='Coefficient lambda to balance loss.')
...
save_model_path = 'checkpoint/checkpoint_YELP.pt'
